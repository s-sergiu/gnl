...
argglobal
terminal ++curwin ++cols=90 ++rows=81 
...
silent! normal! zE
let &fdl = &fdl
let s:l = 115 - ((75 * winheight(0) + 40) / 81)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 115
...
silent! normal! zE
let &fdl = &fdl
let s:l = 47 - ((33 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 47
...
argglobal
terminal ++curwin ++cols=182 ++rows=81 
let s:term_buf_14 = bufnr()
balt ~/Projects/tests/test.c
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
